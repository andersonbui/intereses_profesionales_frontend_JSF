...
import com.ingesoft.interpro.entidades.Ciudad;
import com.ingesoft.interpro.controladores.util.JsfUtil;
import com.ingesoft.interpro.controladores.util.JsfUtil.PersistAction;
import com.ingesoft.interpro.entidades.Departamento;
import com.ingesoft.interpro.facades.CiudadFacade;
...
public class CiudadController implements Serializable {
    ...
    public void asignarItems(Departamento depto) {
        System.out.println("asignando ciudades: " + depto);
        if (depto != null) {
            List<Ciudad> ciudades = depto.getCiudadList();
            items = ciudades;
        }
    }
