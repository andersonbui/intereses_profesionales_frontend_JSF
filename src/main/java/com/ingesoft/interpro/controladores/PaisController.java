...
import com.ingesoft.interpro.entidades.Pais;
import com.ingesoft.interpro.controladores.util.JsfUtil;
import com.ingesoft.interpro.controladores.util.JsfUtil.PersistAction;
import com.ingesoft.interpro.facades.PaisFacade;
...
public class PaisController implements Serializable {
    ...
    public Pais getSelected() {
        System.out.println("pais getSelected: " + selected);
        return selected;
    }

    public void setSelected(Pais selected) {
        System.out.println("pais setSelected: " + selected);
