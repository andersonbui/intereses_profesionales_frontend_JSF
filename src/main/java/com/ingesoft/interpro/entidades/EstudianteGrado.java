...
@NamedQueries({
    ...
    , @NamedQuery(name = "EstudianteGrado.findByIdEstudiante", query = "SELECT e FROM EstudianteGrado e WHERE e.estudianteGradoPK.idEstudiante = :idEstudiante ORDER BY e.fecha DESC")})
